...
func TestCheckNineSquaresAllCorrectCells(t *testing.T) {
	...
	assert.True(t, solvers.CheckNineSquares(board, 2))
	assert.True(t, solvers.CheckNineSquares(board, 3))
	assert.True(t, solvers.CheckNineSquares(board, 4))
	assert.True(t, solvers.CheckNineSquares(board, 5))
	assert.True(t, solvers.CheckNineSquares(board, 6))
	assert.True(t, solvers.CheckNineSquares(board, 7))
	assert.True(t, solvers.CheckNineSquares(board, 8))
	assert.True(t, solvers.CheckNineSquares(board, 9))
	assert.True(t, solvers.CheckNineSquares(board, 10))
	assert.True(t, solvers.CheckNineSquares(board, 20))
	assert.True(t, solvers.CheckNineSquares(board, 30))
	assert.True(t, solvers.CheckNineSquares(board, 40))
	assert.True(t, solvers.CheckNineSquares(board, 50))
	assert.True(t, solvers.CheckNineSquares(board, 60))
	assert.True(t, solvers.CheckNineSquares(board, 70))
	assert.True(t, solvers.CheckNineSquares(board, 80))
...
func TestCheckNineSquaresDuplicateBottomRight(t *testing.T) {
	...
	assert.True(t, solvers.CheckNineSquares(board, 40))
	assert.True(t, solvers.CheckNineSquares(board, 50))
	assert.False(t, solvers.CheckNineSquares(board, 60))
	assert.False(t, solvers.CheckNineSquares(board, 70))
	assert.False(t, solvers.CheckNineSquares(board, 80))
...
func TestCheckNineSquaresDuplicateTopRight(t *testing.T) {
	...
	assert.False(t, solvers.CheckNineSquares(board, 2))
	assert.True(t, solvers.CheckNineSquares(board, 3))
	assert.True(t, solvers.CheckNineSquares(board, 4))
	assert.True(t, solvers.CheckNineSquares(board, 5))
	assert.True(t, solvers.CheckNineSquares(board, 6))
	assert.True(t, solvers.CheckNineSquares(board, 7))
	assert.True(t, solvers.CheckNineSquares(board, 8))
	assert.False(t, solvers.CheckNineSquares(board, 9))
	assert.False(t, solvers.CheckNineSquares(board, 10))
	assert.False(t, solvers.CheckNineSquares(board, 20))
	assert.True(t, solvers.CheckNineSquares(board, 30))
	assert.True(t, solvers.CheckNineSquares(board, 40))
	assert.True(t, solvers.CheckNineSquares(board, 50))
	assert.True(t, solvers.CheckNineSquares(board, 60))
...
func TestGetSudokuSquareIndexes(t *testing.T) {
	...
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 0))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 1))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 2))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 9))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 10))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 11))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 18))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 19))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 20))

	// Top center
	expectedSquareIndexes = []int{3,4,5,12,13,14,21,22,23}

	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 3))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 4))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 5))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 12))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 13))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 14))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 21))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 22))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 23))

	// Top right
	expectedSquareIndexes = []int{6,7,8,15,16,17,24,25,26}

	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 6))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 7))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 8))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 15))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 16))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 17))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 24))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 25))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 26))

	// Bottom right
	expectedSquareIndexes = []int{60,61,62,69,70,71,78,79,80}

	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 60))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 61))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 62))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 69))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 70))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 71))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 78))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 79))
	assert.Equal(t, expectedSquareIndexes, solvers.GetSudokuSquareIndexes(board, 80))
